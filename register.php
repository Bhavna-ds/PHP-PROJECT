...
<body style="background-image:url('img/234.jpg')">
    <header>
     <marquee> <center><div style="background:yellow;width:850px"><h2 style="font-weight:bold;color:brown;font-style:italic;font-size:50px">WELCOME TO STUDY DUNIYA</h2></div> </header></center></marquee>
    <center><div class="container" style="width:450px;border:15px solid red;background:yellow">
        <!-- Example form -->
